"Модуль, содержащий класс Calculator для выполнения арифметических операций над числами"
...
class Calculator:
    ...
    def divide_numbers(self, num1, num2):
        "Вычисление частного от деления чисел, если делить на ноль, то происходит ошибка"
        self._check_args(num1, num2)
        if num2 == 0:
